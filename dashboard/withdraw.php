...
$description = "$symbol $amount  withdrawal placed for $portifolioName";
...
if($amount <= $portifolioBalance){
    ...
    if( $insert_trx){
        ...
        echo "
        <script>
            swal('Great','We have received your request. you will be contacted soon','success')
            .then(()=>{
    ...
    echo "
        <script>
            swal('Oops','Not enough funds ','warning');
            </script>
        ";
