...
<div class="row">
    <div class="col col-lg-5 mx-auto">
        <div class="card">
            ...
            <div class="card-body">
                <p>Total balance <span class="display-6 float-end">$<?php echo $total_portfolio_balance; ?></span></p>
                <p>Total profit <span class="display-6 float-end">$<?php echo $total_profit; ?></span></p>
