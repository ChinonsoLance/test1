                    ...
                    <div class="col-lg-6 col-md-12 col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <h3 class="card-title mb-2">$<?php echo $balance; ?>
                    ...
                    <div class="col-lg-6 col-md-12 col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <h3 class="card-title text-nowrap mb-1 ">$<?php echo $total_profit; ?>
                    ...
                    <div class="col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <h3 class="card-title text-nowrap mb-2"><?php echo $num_active_portifolio; ?></h3>
                    ...
                    <div class="col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <h3 class="card-title mb-2 ">$<?php echo $ref_bonus; ?></h3>
                            ...
                            <div class="d-flex flex-sm-column flex-row align-items-start justify-content-between">
                              ...
                              <div class="mt-sm-auto">
                                <small class="text-success  fw-semibold"
                                  ><i class="bx bx-chevron-up"></i> Deposited</small
                                >
                                <h3 class="mb-0 ">$<?php echo $total_deposited; ?></h3>
