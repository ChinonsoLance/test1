...
<p class='text-mute'>$tick Analysis monthly for the past 365 days</p>
";
...
<html>
  ...
  <body>
    <div class="row mb-3">
        ...
        <div id="chart_div" style="width: 80vw; height: 500px;"></div>
        <div class="card">
          <div class="card-body">
            <div class="row">
              <div class="col-6">
            ...
            <center>
                <a href="create-portifolio.php?ticker=<?php echo $tick; ?>">
