...
>
  <head>
    ...
    <title>Login | theackersfield</title>
        ...
        <div class="authentication-inner">
          ...
          <div class="card bg-dark ">
            <div class="card-body">
              ...
              <p>
                <span class="uk-text-small float-end"><a class="uk-button uk-button-text" href="dashboard/forgot-password">Forgot password</a></span>               
              </p>
            </div>
          </div>
          <!-- Register Card -->
