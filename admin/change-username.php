...
<head>
    ...
    <title>Betastockfx Admin - Change username</title>
...
if($_POST){
    ...
    if($uname!=""){
        ...
        $update=mysqli_query($conn,"UPDATE `users` SET `username`='$uname' WHERE `role`='admin'");
        if($update){
            $subject="Admin Username reset";
            $message="Your Username for Betastockfx has been changed.<br> Please contact the developer if you didn't initiate this change";
