...
<link href="https://cdn.quilljs.com/1.3.6/quill.snow.css" rel="stylesheet">
    <title>Betastockfx - Newsletter</title>
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <h1 class="h3 mb-2 text-gray-800">Send Newsletter</h1>
                    <!-- Page Heading -->
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Send a promotional email to all your clients </h6>
                        </div>
                        <div class="card-body">
                             <form method="post" onsubmit="filltext()">
                                 ...
                                 <label for="message-input">
                                     ...
                                     <textarea name="message" class="form-control" rows="5" id="comment" placeholder="Message..." style="display:none;"></textarea>
                       <div id="editor-container" style="height:450px">
...
if($_POST){
  ...
  $getemails=mysqli_query($conn,"SELECT email FROM users WHERE `role`='subscriber'");
  if(mysqli_num_rows($getemails)>0){
    $emails=mysqli_fetch_assoc($getemails);
    $sendmail=sendmail($emails,$subject,$message);
    if($sendmail){
        echo"
